...
def generate_random_user_agent(device_type='android', browser_type='chrome'):
    ...
    if device_type == 'android':
        ...
        telegram_versions = [
            '10.13.3', '10.14.0', '10.14.2', '10.14.3', '10.14.4', '10.14.5', '10.15.0',
            '10.15.1', '11.0.0' , '11.0.1', '11.1.0' , '11.1.1', '11.1.2', '11.1.3',
        ...
        if browser_type == 'chrome':
            return (f"Mozilla/5.0 (Linux; Android {android_version}; {android_device}) AppleWebKit/537.36 "
                    ...
                    f"({android_device}; Android {android_version}; SDK 33; AVERAGE)"
                    )
        elif browser_type == 'firefox':
